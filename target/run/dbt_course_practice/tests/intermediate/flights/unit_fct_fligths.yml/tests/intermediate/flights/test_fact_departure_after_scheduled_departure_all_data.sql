...
with dbt_internal_unit_test_actual as (
  select
    "flight_id","flight_no","scheduled_departure","scheduled_arrival","departure_airport","arrival_airport","status","aircraft_code","actual_departure","actual_arrival","flight_departure_delay", 'actual' as "actual_or_expected"
  from (
...
dbt_internal_unit_test_expected as (
  select
    "flight_id", "flight_no", "scheduled_departure", "scheduled_arrival", "departure_airport", "arrival_airport", "status", "aircraft_code", "actual_departure", "actual_arrival", "flight_departure_delay", 'expected' as "actual_or_expected"
  from (
    select 
